                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(child: AutoSizeText("درجة الحرارة : ", style: H2BlackTextStyle)),
                            SizedBox(width: 0.01.sw,),
                            Flexible(
                              child: AutoSizeText("${weather.temp_c} \u00B0C",
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Flexible(child: AutoSizeText("سرعة الرياح :", style: H2BlackTextStyle)),
SizedBox(width: 0.01.sw,),
                            Flexible(
                              child: Row(
                                children: [
                                  AutoSizeText("${weather.wind} ",
                                      style: H2BlackTextStyle.copyWith(
                                          color: Colors.black)),
                                  AutoSizeText("كم / سا",
