...
class EditTenderPage extends StatelessWidget {
  EditTenderPage({Key? key}) : super(key: key);

  final logic = Get.find<EditTenderLogic>();
                  ...
                  child: FormBuilder(
                    ...
                    child: Column(children: [
                     ...
                     Obx(() {
                       ...
                       ),visible: logic.attachments.length==0,);
                     }),
                      30.verticalSpace,
                      Container(
                        width: 1.sw,
