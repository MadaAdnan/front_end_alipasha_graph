...
class PostHomeItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () {
          Get.toNamed(
              PRODUCT_PAGE, arguments: post.id, preventDuplicates: false);
        },
        child: Container(
          width: 0.92.sw,
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    Get.toNamed(PRODUCTS_PAGE,arguments:post.user ,parameters: {"id":"${post.user!.id}"});
                  },
                  child: Padding(
                                ...
                                children: [
                                  Flexible(
                                    child: InkWell(
                                      onTap: () {
                                        Get.toNamed(
                                            PRODUCTS_PAGE, arguments: post.user,
                                            parameters: {
                                              "id": "${post.user!.id}"
                                            });
                                      },
                        ...
                        Obx(() {
                          if (mainController.authUser.value?.id != null &&
                            ...
                            if (mainController.authUser.value!.followers !=
                                null) {
                              int index = mainController.authUser.value!
                                  .followers!
                                  .indexWhere(
              ...
              Padding(
                ...
                child: ClipRRect(
                  ...
                  child: Stack(
                    alignment: Alignment.center, // 👈 أهم سطر
                    children: [
                      AspectRatio(
                        aspectRatio: 300 / 300,
                        child: Image.network(
                ...
                child: Row(
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          '\$ ${post.is_discount == true ? post.discount : post
                              .price}',
                          style: TextStyle(
                            fontSize: 20,
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 6),
                                Text(
                                  '${plusOneLike.value == true ? post
                                      .likes_count! + 1 : post.likes_count}'
                                      .toFormatNumberK(),
                                  style: TextStyle(
                                    fontSize: 13,
                              ...
                              children: [
                                MaterialButton(
                                  onPressed: () async {
                                    ...
                                    message.write("\n");
                                    message.write(
                                        "سعر الوحدة : ${post.is_discount == true
                                            ? post.discount
                                            : post.price}");
                                    message.write("\n");
