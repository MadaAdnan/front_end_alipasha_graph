...
const String SECTIONS_PAGE = '/sections_page';
...
const String PRIVACY_PAGE = '/privacy_page';
const String ABOUT_PAGE = '/about_page';
...
const String CUR_PAGE = '/cur_page';
const String PRAYER_PAGE = '/pryer_page';
const String SERVICES_PAGE = '/services_page';
